  ...
  const HandleComplaintSubmit = () => {
    ...
    if (customerEmail.length === 0) {
      ...
      setSubmitComplaintError(
        'No subject provided. Subject is a required field'
      );
    } else if (description.length === 0) {
      setSubmitComplaintError(
        'No description provided. Description is a required field'
      );
      ...
      setSubmitComplaintError('');
      alert(
        'Your complaint has been submitted successfully. Thank you for reaching out to us and bringing the issue to our attention. Your feedback is highly valuable to us!'
      );
    }
  };
    ...
    <div>
      ...
      <section className="contact-us-wrapper">
        <section className="contact-us-header">
          ...
          <p>
            Just fill out the form below and we'll be in touch as soon as
            possible.
          </p>
        </section>
        ...
        <section className="contact-us-details-section">
          ...
          <Form.Group className="mb-5">
            ...
            <Form.Select
              aria-label="help subject select"
              className="contact-us-textbox text-control-focus-style"
            ...
            >
              ...
              <option value="Searching on our website">
                Searching on our website
              </option>
              <option value="Website or app feedback">
          ...
          >
            <Form.Control
              as="textarea"
              placeholder=""
              className="description-text-area text-control-focus-style"
              style={{ height: 150 }}
