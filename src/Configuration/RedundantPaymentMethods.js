<div className="details-section-sub-div">
  ...
  <Form>
    <Form.Group className="form-control-no-text">
      <Form.Text className="card-types-accepted-header">
        Card types accepted:
      </Form.Text>
      ...
      {visaPaymentSelected && (
        <div>
          <p className="section-sub-header">
            {' '}
            Complete Payment With {paymentMethod}{' '}
          </p>
          <Form.Group className="form-control-no-text">
            <Form.Control
              className="text-control-focus-style"
              type="text"
              placeholder="Name on card *"
              onChange={UpdateCustomerPaymentCardName}
            />
            <Form.Text>
          ...
          <Form.Group className="form-control-no-text">
            <Form.Control
              ...
              onChange={UpdateCustomerPaymentBookingEmail}
            />
            <Form.Text>
              We’ll send your booking confirmation to this email address. Make
              sure it’s correct.
            </Form.Text>
          </Form.Group>
          ...
          <Form.Group>
            <Form.Control
              ...
              onChange={UpdateCustomerPaymentCardNumber}
            />
          </Form.Group>
          ...
          <Row className="form-control-no-text">
            ...
            <Col>
              ...
              >
                <option value="-- Select --" className="card-expiry-month-text">
                  -- Expiry Month --
                </option>
            ...
            <Col>
              ...
              >
                <option value="-- Select --" className="card-expiry-year-text">
                  -- Expiry Year --
                </option>
          ...
          <Form.Group className="form-control-no-text">
            <Form.Control
              ...
              onChange={UpdateCustomerPaymentCardSecurityCode}
            />
