...
const FetchAllRooms = () => {
  ...
  let trendingHotelsArray = [
    {
      coverImage: trending_accra_marriott_cover,
      hotelName: 'Accra Marriott Hotel',
      averagePrice: 3206,
    },
    {
      coverImage: trending_movenpick_cover,
      hotelName: 'Movempick Ambassador Hotel',
      averagePrice: 3000,
    },
    {
      coverImage: trending_kempinski_cover,
      hotelName: 'Kempinski Hotel',
      averagePrice: 3407,
    },
    {
      coverImage: trending_mensvic_cover,
      hotelName: 'Mensvic Grand Hotel',
      averagePrice: 2345,
    },
  ];
